...
const ContentCard = ({
  ...
  return (
    <div
      ...
      onClick={() => clickCard()}
    >
      <div className="absolute top-2 right-2 p-1 hover:scale-110 duration-200 cursor-pointer rounded-full group-hover:bg-neutral-100 group-hover:dark:bg-neutral-800">
        <CustomDropdown
          closeOnSelect={false}
          title={
            <Icon
