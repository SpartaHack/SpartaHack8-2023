          ...
          <Dialog as="div" className="absolute z-10" onClose={handleClose}>
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-end lg:pb-[115px] pb-[90px] lg:mr-5 justify-end p-4 text-center">
                ...
                >
                  <Dialog.Panel className="relative w-full bg-absolute_white max-w-lg h-[80vh] lg:h-[75vh] overflow-y-auto transform rounded-lg p-6 text-left transition-all flex flex-col dark:bg-black dark:border dark:border-neutral-800 drop-shadow">
                    <SpaceChatMain />
                  </Dialog.Panel>
                </Transition.Child>
              </div>
