...
export const faqData = [
  {
    ...
    content: (
      <h1>
        ...
        videos &amp; PDFs, 10 AI generated responses for each upload, and one dedicated space at no cost. Opt for the Pro
        Plan at $8 / month for unlimited access to contents, AI responses, spaces, and an AI-space chatbot,
        ideal for daily learners.
      </h1>
    ),
    subtitle: <h3>Plan</h3>,
  },
  {
    ...
    content: <h1>We support payment through credit card, Google Pay, and Link.</h1>,
  ...
  },
  {
    ...
    content: (
      <h1>
        ...
        organized learning resources. Additionally, it includes an AI-space chatbot to ask
        about anything and everything in each space.
      </h1>
    ),
  ...
  },
  {
    ...
    content: (
      <h1>
        ...
        we&apos;ll guide you through the steps to ensure a
