    ...
    <>
      <form className="container mx-auto">
        ...
        <CustomButton
          ...
          btnStyling="bg-secondary py-6 text-black font-bold flex items-center justify-center rounded-md h-[50.5px] w-full"
        />
        <CustomButton
          title="👋 Schedule a 20 min meeting with the founders"
          btnType="button"
          btnStyling="bg-black dark:bg-white text-white dark:text-black font-bold flex items-center justify-center rounded-md h-[50.5px] w-full mt-4"
        ...
        <CustomButton
          ...
          btnType="button"
          btnStyling="bg-[#9B59B6] text-white font-bold flex items-center justify-center rounded-md h-[50.5px] w-full mt-4"
