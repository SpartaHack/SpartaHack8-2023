      ...
      {questions &&
        questions.map((question: string, index: number) => (
          <div key={index} className="w-1/2 pt-2 px-1">
            <div
              className={`items-center flex h-full text-neutral-500 dark:text-neutral-400 dark:border-neutral-400 dark:hover:bg-secondary dark:hover:text-black dark:hover:border-black dark:hover-black border p-2 rounded-md text-sm hover:text-black hover:border-neutral-200 ${
