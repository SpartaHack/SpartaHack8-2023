...
const Footer = () => {
  return (
    <footer className='flex justify-between items-center flex-wrap border-t border-neutral-300 dark:border-neutral-700 sm:px-16 py-3'>
      <p className='md:block hidden'>@2023 YouLearn, Inc. All rights reserved</p>
