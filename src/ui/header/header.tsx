...
export default function Header() {
  ...
  return (
    <div className="border-b dark:border-neutral-800">
      <Navbar maxWidth="full" isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} shouldHideOnScroll className="sticky top-0 z-10 bg-neutral-100  dark:bg-neutral-900">
        ...
        <NavbarMenu onClick={handleClick} className='w-[50%] drop-shadow-sm md:w-[25%] overflow-hidden lg:w-[18%] bg-white dark:bg-neutral-900 border-t dark:border-neutral-800 ' motionProps={sideBarMotion}>
        <div ref={ref}>  
          <MenuItems/>
        </div>
      </NavbarMenu>
