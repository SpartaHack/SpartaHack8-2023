      ...
      >
        {spaces ? (
          spaces.filter(Boolean).map((space: getUserSpaceResponse) => (
            <div
              key={space._id}
              className="flex justify-between flex-row group w-full cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-700 p-2 rounded-md"
        ...
        <div
          className="flex flex-row w-full cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-700 p-2 rounded-md"
