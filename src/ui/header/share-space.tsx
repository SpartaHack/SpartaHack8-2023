        ...
        <ModalContent className="prevent-close">
                ...
                {/* <CustomTextInput
                  ...
                  endContent={
                    <CustomButton
                      ...
                      fullWidth={false}
                      title="Share"
                      btnStyling="w-3 dark:bg-white bg-black text-white py-2 dark:text-black font-semibold flex items-center justify-center rounded-md"
                    />
                  }
          ...
          <ModalFooter>
            <CustomButton
              ...
              size="lg"
              btnType="button"
              btnStyling="dark:bg-white bg-black text-white py-2 dark:text-black font-semibold flex items-center justify-center rounded-md"
            />
          </ModalFooter>
        </ModalContent>
      </Modal>
