...
const PriceCard = ({ price, subTitle, planBenefits, buttonText, handleClick }: PriceCardProps) => {
  ...
  return (
    <div className='rounded-xl justify-between bg-white dark:bg-black w-[75%] lg:h-[450px] h-[320px] px-[60px] lg:w-[40%] shadow-xl border dark:border-none p-3 text-center cursor-pointer hover:scale-105 transition duration-500'>
