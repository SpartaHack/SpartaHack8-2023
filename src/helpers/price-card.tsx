...
const PriceCard = ({ price, subTitle, planBenefits, buttonText, route }: PriceCardProps) => {
  ...
  return (
    <div className='rounded-[10px] justify-between bg-white dark:bg-black backdrop-blur-md w-[75%] lg:h-[450px] h-[320px] px-[60px] lg:w-[40%] shadow-xl border dark:border-black p-3 text-center cursor-pointer hover:scale-105 transition duration-500'>
