...
export const freePlanBenefits: Features[] = [
    ...
    {icon: <Icon icon="mingcute:lock-line" className='w-4 h-4 lg:w-5 lg:h-5 mt-0.5 text-tertiary dark:text-secondary'/>  , label: "Regular AI model",},
  ...
  export const premiumMonthlyPlanBenefits: Features[] = [
    ...
    {icon: <Icon icon="mdi:tick-circle-outline" className='w-4 h-4 lg:w-5 lg:h-5 mt-0.5 text-tertiary dark:text-secondary'/>  , label: "Enhanced AI model"},
